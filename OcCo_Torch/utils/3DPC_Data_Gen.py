...
import os, sys, pdb, h5py, numpy as np

'''
THe original object is split into voxels along axes, 
each point is assigned a voxel label.
'''
...
def pc_ssl_3djigsaw_gen(pc_xyz, k=2, edge_len=1):
	...
	"""
	# TODO: the span on some axis are narrower than others
	...
	for voxel_id in range(k ** 3):
		...
		# loc = numberToBase(permutated_places)
