...
from S3DISDataLoader import CityDataset_HDF5
from torch.utils.data import DataLoader
from TrainLogger import TrainLogger
from tqdm import tqdm


classes = ['ground', 'veg', 'building', 'wall', 'bridge',
           'parking', 'rail', 'traffic', 'street', 'car',
           'footpath', 'bike', 'water']
...
def main(args):
    ...
    TRAIN_DATASET = CityDataset_HDF5(root=root, split='train')
    TEST_DATASET = CityDataset_HDF5(root=root, split='test')
