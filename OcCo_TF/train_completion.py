...
from utils.data_util import lmdb_dataflow
from utils.tf_util import add_train_summary
...
parser.add_argument('--batch_size', type=int, default=16)  # pcn -> 32
...
parser.add_argument('--steps_per_visu', type=int, default=3456)  # default is 3000
...
BN_DECAY_DECAY_STEP = float(DECAY_STEP)  # aligned with learning rate decay
BN_DECAY_CLIP = 0.99
...
if __name__ == '__main__':
	# data_dir = '/home/zelda/hw501/my_scratch/data_source/PCN/shapenet'
